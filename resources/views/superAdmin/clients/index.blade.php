            ...
            <div class="card card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        <a href="{{ route('subAdminAddClient') }}" class="btn btn-primary">
                            Add Client
                        </a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="ms-5">
                                                <a href="{{ route('subAdminViewClient', $client->user_id) }}" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">{{ decrypt($client->first_name) . ' ' . decrypt($client->last_name) }}</a>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('subAdminViewClient', $client->user_id) }}" class="menu-link px-3"> View </a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a href="{{ route('subAdminUpdateClient', $client->user_id) }}" class="menu-link px-3"> Edit </a>
                                            </div>
                                            <div class="menu-item px-3">
