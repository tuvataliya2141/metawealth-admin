        ...
        <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('subAdminAllAdvisors') }}" class="text-muted text-hover-primary"> All Advisors </a>
                    </li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
                    </li>
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                ...
                                <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit advisor details">
                                    <a href="{{ route('subAdminUpdateAdvisor', $advisorDetails['user']->id) }}" class="btn btn-sm btn-light-primary"> Edit </a>
                                </span>
                            </div>
                                                ...
                                                <td class="pe-0 text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('subAdminViewClient', $user->id) }}" class="menu-link px-3"> View </a>
                                                        </div>
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('subAdminUpdateClient', $user->id) }}" class="menu-link px-3"> Edit </a>
                                                        </div>
                                                        <div class="menu-item px-3">
