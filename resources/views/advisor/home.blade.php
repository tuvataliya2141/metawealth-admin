                                    ...
                                    @if(count($users) > 0)
                                        ...
                                        @foreach($users as $key => $user)
                                            @if($key < 6)
                                                ...
                                                @endif
                                            @else
                                            <a href="{{ route('advisorAllClients') }}" class="symbol symbol-35px symbol-circle">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex justify-content-start flex-column">
                                                                <a href="{{ route('advisorViewClient', $user->id) }}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{{ $user->name }}</a>
                                                            </div>
                                                        </div>
                                                    </td>
