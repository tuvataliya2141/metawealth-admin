...
var KTAppAdvisors = function () {
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                // Get advisor id
                const advisorId = d.getAttribute('data-advisor-id');
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url : "advisors/delete-advisor/"+advisorId,
                            type : 'get',
                            dataType : 'json',
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_advisors_table');
            if (!table) {
                return;
            }
            initDatatable();
