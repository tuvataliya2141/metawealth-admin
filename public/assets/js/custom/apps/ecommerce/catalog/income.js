...
var KTAppIncomes = function () {
    ...
    var initDatatable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            'columnDefs': [
                ...
                { orderable: false, targets: 1 }, // Disable ordering on column 5 (actions)
            ]
        });
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                // Get income id
                const incomeId = d.getAttribute('data-income-id');
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url : "incomes/delete-income/"+incomeId,
                            type : 'get',
                            dataType : 'json',
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_incomes_table');
            if (!table) {
                return;
            }
            initDatatable();
