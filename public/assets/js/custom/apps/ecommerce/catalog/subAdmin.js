...
var KTAppSubAdmins = function () {
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                // Get subAdmin id
                const subAdminId = d.getAttribute('data-subAdmins-id');
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url : "subAdmin/delete-subAdmins/"+subAdminId,
                            type : 'get',
                            dataType : 'json',
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_subAdmins_table');
            if (!table) {
                return;
            }
            initDatatable();
