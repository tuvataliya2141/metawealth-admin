...
var KTChartsIncomes = function () {
    ...
    var initChart = function(chart) {
        var element = document.getElementById("kt_charts_incomes");
        var IncomeChartData = JSON.parse($('.line_chart_data').val());
        var chartXaxis = [];
        var chartYaxis = [];
        IncomeChartData.line_data.forEach(function(item){
        ...
        const YtickAmount = Math.ceil((maxIncome - minIncome) / 2000);
        const XcategoriesCount = chartXaxis.length;
        const XtickAmount = Math.ceil(XcategoriesCount / 10);
