...
class SuperAdminController extends Controller
{
    public function index() {
        ...
        return view('superAdmin.home', compact(['users', 'advisors']));
    }
    ...
    public function allClients() {
        ...
        return view('superAdmin.clients.index', compact(['clients', 'advisors']));
    }

    public function addClient() {
        return view('superAdmin.clients.addClient');
    }
            ...
            if ($user) {
                ...
                if($result) {
                    ...
                    if($personalDetails) {
                        ...
                        return redirect()->route('subAdminAllClients')->with('success', 'Data added successfully!');
                    }
                }
            }
        } else {
    ...
    public function updateClient($id) {
        ...
        return view('superAdmin.clients.updateClient', compact(['client']));
    }
    ...
    public function editClient(Request $request) {
        ...
        if($findVal == 0) {
            ...
            return redirect()->route('subAdminAllClients')->with('success', 'Data updated successfully!');
        } else {
            return redirect()->back()->with('error', 'Phone number is already registered, please try again with different phone no.!');
        }
    }
    ...
    public function viewClient($id) {
        ...
        // dd($clientDetail);
        return view('superAdmin.clients.view', compact(['clientDetail', 'incomes', 'events', 'totalWealth', 'userAge', 'rateReturn', 'wealthIncomes', 'incomeChart', 'wealthEvents', 'eventsChart', 'allAdvisors']));
    }
    ...
    public function allAdvisors() {
        ...
        return view('superAdmin.advisors.index', compact(['advisors']));
    }

    public function addAdvisor() {
        return view('superAdmin.advisors.addAdvisor');
    }
    ...
    public function storeAdvisor(Request $request) {
        ...
        if ($user) {
            ...
            if($result) {
                ...
                if($personalDetails) {
                    return redirect()->route('subAdminAllAdvisors');
                }
            }
        }
    }
    ...
    public function updateAdvisor($id) {
        ...
        return view('superAdmin.advisors.updateAdvisor', compact(['advisor']));
    }
    ...
    public function editAdvisor(Request $request) {
        ...
        if($advisor->update()) {
            return redirect()->route('subAdminAllAdvisors')->with('success', 'Advisors Details Updated Successfully.');
        } else {
            return redirect()->route('subAdminAllAdvisors')->with('error', 'Advisors Details Not Updated Successfully.');
        }
    }
    ...
    public function viewAdvisor($id) {
        ...
        return view('superAdmin.advisors.view', compact(['advisorDetails']));
    }

    // Booking
    public function booking() {
        return view('superAdmin.booking.index');
    }
    ...
    public function updateRole($id) {
        ...
        return view('superAdmin.roles.updateRole', compact(['roles']));
    }
    ...
    public function editRole(Request $request) {
        ...
        if($roles->update()){
            return redirect()->route('subAdminAllRoles')->with('success', 'Role Updated Successfully.');
        }
    }
    ...
    public function map() {
        ...
        return view('superAdmin.map.index', compact(['address_lat_long']));
    }
    ...
    public function editProfile(Request $request) {
        ...
        if(isset($request->current_pass) && isset($request->password)) {
            ...
            if(Auth::attempt(['email' => $request->email, 'password' => $request->current_pass])) {
                ...
                if ($user->update()) {
                    return redirect()->route('subAdminProfile')->with('success', 'Password Changed Successfully.');
                }                    
            } else {
                return redirect()->route('subAdminProfile')->with('error', 'Current password is wrong, Please try again.');
            }
        }
        ...
        if ($user->update()) {
            return redirect()->route('subAdminProfile')->with('success', 'Detaild Changed Successfully.');
        }
    }
